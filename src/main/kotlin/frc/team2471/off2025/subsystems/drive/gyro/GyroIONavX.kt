...
class GyroIONavX : GyroIO {
    ...
    private val yawPositionQueue: Queue<Double?> = PhoenixOdometryThread.instance.registerSignal { -navX.yaw.toDouble() }
    private val yawTimestampQueue: Queue<Double?> = PhoenixOdometryThread.instance.makeTimestampQueue()
